...
while [ $sec -gt 0 ]; do
	...
	let "sec=sec-1"
	echo -ne "${GREEN}"
	echo -e "Vicidial-Scratch-Install-AlmaLinux-10.X-x86_64-Minimal-Server"
	echo -ne "${YELLOW}"
...
#wget -O ./Vicidial-Scratch-Install-AlmaLinux-10.X-x86_64-Minimal-Server.zip https://github.com/ashloverscn/Vicidial-Scratch-Install-AlmaLinux-10.X-x86_64-Minimal-Server/archive/refs/heads/main.zip
...
echo -e "\e[0;32m Vicidial-Scratch-Install-AlmaLinux-10.X-x86_64-Minimal-Server Installation Complete! \e[0m"
